        ...
        extends JComponent
{
    ...
    public Paint_App()
    {
        this.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseReleased(MouseEvent e)
            {
                ...
                {
                    Linie obj = new Linie(startDrag, new Point(e.getX(), e.getY()), GUI.selectColor);
                    obj.makeObject(startDrag, p);
                    GUI.paint.add(obj);
                }
    ...
    public void paint(Graphics g)
    {
        ...
        if (startDrag != null && endDrag != null)
        {
            ...
            {
                if (ptemp instanceof Dreptunghi)
                {
                    Dreptunghi r = (Dreptunghi) ptemp;
                ...
                else if (ptemp instanceof Oval)
                {
                    Oval oval = (Oval) ptemp;
                ...
                else if (ptemp instanceof Triunghi)
                {
                    Triunghi tr = (Triunghi) ptemp;
                    if (tr.contains(startDrag))
                    {
                        int[] x =
                        {
                            tr.getTriangle().xpoints[0] + endDrag.x - startDrag.x, tr.getTriangle().xpoints[1] + endDrag.x - startDrag.x, tr.getTriangle().xpoints[2] + endDrag.x - startDrag.x
                        };
                        int[] y =
                        {
                            tr.getTriangle().ypoints[0] + endDrag.y - startDrag.y, tr.getTriangle().ypoints[1] + endDrag.y - startDrag.y, tr.getTriangle().ypoints[2] + endDrag.y - startDrag.y
                        };
                        if (tr.getColor() == null)
                        {
                ...
                else if (ptemp instanceof Linie)
                {
                    Linie tr = (Linie) ptemp;
                    if (tr.contains(startDrag))
                    {
                        g2.getGraphicAdapter().setColor(tr.getColor());
