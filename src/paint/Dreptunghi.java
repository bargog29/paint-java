...
public class Dreptunghi implements Class2D{
	...
	public Dreptunghi(Rectangle r) {
		this.rect = r;
	}
	public Dreptunghi(Rectangle r, Color lc) {
		this.rect = r;
		this.lineColor = lc;
	}
	public Dreptunghi(Rectangle r, Color lc, Color c) {
		this.rect = r;
		this.lineColor = lc;
		this.color = c;
	}
